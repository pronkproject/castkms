...
//! Reference-counted DMA-BUF storage and synchronization abstractions.
//!
//! A buffer reference keeps the allocation alive. It does not make its pixels
//! immutable, establish access synchronization, or revoke access previously
//! granted through another reference.
