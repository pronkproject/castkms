...
const unsigned int RUST_CONST_HELPER_DRM_MODESET_ACQUIRE_INTERRUPTIBLE =
	DRM_MODESET_ACQUIRE_INTERRUPTIBLE;
const unsigned int RUST_CONST_HELPER_DRM_MODE_PROP_SIGNED_RANGE = DRM_MODE_PROP_SIGNED_RANGE;
...
const fmode_t RUST_CONST_HELPER_FMODE_WRITE = FMODE_WRITE;
const fmode_t RUST_CONST_HELPER_FMODE_READ = FMODE_READ;
